 ...
 */
 ...
 /**
  * Provides a representation of a FlexForm for 
  * <b>security testing only</b>. This package will
  * be removed once the framework is integrated into 
  * the core platform.
  *
  * @author Dale Churchett
  * @version $Id: ExcelForm.java,v 1.2 2012/04/23 14:25:16 dalehippikon Exp $
  * @since JDK 1.2.2
  */
 @ProtectedResource(name="ExcelForm")
