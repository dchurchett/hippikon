...
package com.hippikon.security;
 ...
 /**
  * Signals that a {@link ProtectedResource} could
  * not be located in a {@link PolicyStore}
  *
  * @author Dale Churchett
  * @version $Id: ResourceNotFoundException.java,v 1.2 2012/04/23 14:25:16 dalehippikon Exp $
  * @since JDK 1.2.2
  */
 
 public class ResourceNotFoundException extends Exception {
 
	private static final long serialVersionUID = 6500807942233571212L;

	/**
      * Creates a new ResourceNotFoundException with a 
